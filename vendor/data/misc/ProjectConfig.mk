...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
#BSP: add custom macro by wanghanfeng 20180830 start
CUSTOM_BUILD_VERNO = CY-AB7-H618-A
#BSP: add custom macro by wanghanfeng 20180830 end
...
#ITD: Modify By ISP-CAM Start
CUSTOM_HAL_CAMERA = camera
CUSTOM_HAL_CAM_CAL =
CUSTOM_HAL_COMBO = mt6765
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 start
CUSTOM_SKIN_COLOR_COMPATIBLE = yes
CUSTOM_HAL_IMGSENSOR = s5k3p9sx_mipi_raw s5k3p9sxb_mipi_raw s5kgd1_mipi_raw s5kgd1b_mipi_raw sp250a_mipi_raw sp250ab_mipi_raw gc8034main_mipi_raw gc8034mainb_mipi_raw
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 end
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3p9sx_17201565 s5kgd1_17201558 sp250a_17201564 gc8034_17201548
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 start
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc8034main_mipi_raw gc8034mainb_mipi_raw
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 end
CUSTOM_HAL_LENS = fp5510e2af fp5510ee4af dummy_lens
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 start
CUSTOM_HAL_MAIN2_IMGSENSOR = sp250a_mipi_raw sp250ab_mipi_raw
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 end
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dummy_lens
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 start
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3p9sx_mipi_raw s5k3p9sxb_mipi_raw
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 end
...
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 start
CUSTOM_HAL_SUB_IMGSENSOR = s5kgd1_mipi_raw s5kgd1b_mipi_raw
#ITD:modify ASQHLYB-737 by wei.wang2 20190312 end
#ITD: Modify By ISP-CAM End
...
#ITD: Modify By ISP-CAM Start
CUSTOM_KERNEL_IMGSENSOR = s5k3p9sx_mipi_raw s5kgd1_mipi_raw sp250a_mipi_raw gc8034main_mipi_raw
MTK_CAM_MAX_NUMBER_OF_CAMERA = 4
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = fp5510e2af fp5510ee4af dummy_lens
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = sp250a_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3p9sx_mipi_raw
...
#modify by ASQHLYB-1 ang.gu 20190117 start
CUSTOM_MODEM = ab7_h618_a1
#modify by ASQHLYB-1 ang.gu 20190117 end
...
LCM_FAKE_HEIGHT = 0
LCM_FAKE_WIDTH = 0
#BSP:modify ASQHLYB-5 by baofu.zhang 20190124 start
LCM_HEIGHT = 2340
LCM_WIDTH = 1080
#BSP:modify ASQHLYB-5 by baofu.zhang 20190124 end
#BSP:add XLYLHLWY-4 by zhijun.ye 20180925 start
TRAN_LCM_SUPPORT = yes
#BSP:add XLYLHLWY-4 by zhijun.ye 20180925 end
LIGHT_NVRAM_DAEMON = no
LINUX_KERNEL_VERSION = kernel-4.9
#APP: Modify by fuyu for XWWYLHLYS-269 20181016 start
LOVELYFONTS_SUPPORT = no
#APP: Modify by fuyu for XWWYLHLYS-269 20181016 end
MAXIM_SPEAKER_SUPPORT = no
MD32_TOOLCHAIN_MODULE = IPDesigner/12R2.36-64
MD5_SIZE = 0x01600000
MD5_SMEM_SIZE = 0x00200000
#BSP: Modified XWWYLHLYS-13 by lichen 20180919 start
#BSP: Modified XWWYLHLYS-13 by lichen 20180919 end
MNTL_SUPPORT = no
...
MTK_ANT_SUPPORT = no
#BSP:modify XLYLHLWY-737 by zhijun.ye 20190110 start
#BSP:modify ASQHLYB-200 by baofu.zhang 20190226 start
MTK_AOD_SUPPORT = yes
#BSP:modify ASQHLYB-200 by baofu.zhang 20190226 end
#BSP:modify XLYLHLWY-737 by zhijun.ye 20190110 end
MTK_API_CHECK = no
...
# BSP:modify ASQHLYB-4 by ge.ding 20190125 start
MTK_AUDIO_NUMBER_OF_MIC = 2
# BSP:modify ASQHLYB-4 by ge.ding 20190125 end
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
MTK_AUDIO_RAW_SUPPORT = yes
# BSP:modify ASQHLYB-4 by ge.ding 20190125 start
MTK_AUDIO_SPEAKER_PATH = smartpa_nxp_tfa98xx
# BSP:modify ASQHLYB-4 by ge.ding 20190125 end
...
# BSP:modify ASQHLYB-4 by ge.ding 20190128 start
MTK_BESLOUDNESS_SUPPORT = no
# BSP:modify ASQHLYB-4 by ge.ding 20190128 end
...
#BSP: add custom macro by wanghanfeng 20180830 start
MTK_BUILD_VERNO=AB7-H618A-P-210623V551
#BSP: add custom macro by wanghanfeng 20180830 end
#SID: add XLYLHLWY-16 lijia.chen 20181009 start
FINGERPRINT_BUILD_VERNO=A-210623V551
#SID: add XLYLHLWY-16 lijia.chen 20181009 end
MTK_BWC_SUPPORT = yes
#TSD:add XLYLHLWY-1 by ang.gu 20180921 start
MTK_C2K_LTE_MODE = 0
#TSD:add XLYLHLWY-1 by ang.gu 20180921 end
...
#[ITD] modify for Close HDR by wei.miao 20181112 start
MTK_CAM_HDR_SUPPORT = no
#[ITD] modify for Close HDR by wei.miao 20181112 end
...
#ITD:modify KBSHLES-333 westalgo dualcam by wei.miao 20181104 start
MTK_CAM_STEREO_CAMERA_SUPPORT = yes
TRAN_DUALCAM_DISABLE_RTDOF_BY_MOVE = yes
TRAN_DUALCAM_DISABLE_RTDOF_BY_CAPTURE = yes
TRAN_CAMERA_WESTALGO_DUALCAM = yes
TRAN_WESTALGO_USED_NEWLIB = yes
#ITD:modify KBSHLES-333 westalgo dualcam by wei.miao 20181104 end
#[ITD] add for thirdpart apk by wei.miao 20181106 start
TRAN_CAMERA_THIRDPART = yes
#[ITD] add for thirdpart apk by wei.miao 20181106 end
#ITD:modify for ASQHLYB-1948 camera boost DDR by wei.miao 190423 start
TRAN_CAMERA_BOOST_DDR = yes
#ITD:modify for ASQHLYB-1948 camera boost DDR by wei.miao 190423 end
#ITD:add cam wide_tag CBQHLES-1168 by wei.miao 20181116 start
TRAN_CAMERA_WIDE = yes
TRAN_CAMERA_AR_CORE = yes
#ITD:add cam wide_tag CBQHLES-1168 by wei.miao 20181116 end
MTK_CAM_STEREO_DENOISE_SUPPORT = no
MTK_CAM_SW_VERSION = ver1
MTK_CAM_USER_DBG_LOG_OFF = no
#[ITD] modify for Close VHDR by wei.miao 20181112 start
MTK_CAM_VHDR_SUPPORT = no
#[ITD] modify for Close VHDR by wei.miao 20181112 end
MTK_CAM_VIDEO_FACEBEAUTY_SUPPORT = no
MTK_CAM_VSDOF_SUPPORT = no
MTK_CAM_VSS_SUPPORT = yes
#[ITD] modify for Close ZSDHDR by wei.miao 20181112 start
MTK_CAM_ZSDHDR_SUPPORT = no
#[ITD] modify for Close ZSDHDR by wei.miao 20181112 end
...
#SID:add KBSHLES-1223 lijia.chen 2018.11.12 start
MTK_CTA_SET = no
#SID:add KBSHLES-1223 lijia.chen 2018.11.12 start
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#BSP:add XWWYLHLYS-6 by ronghe.cheng 20180918 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:add XWWYLHLYS-6 by ronghe.cheng 20180918 end
...
# BSP : modify XLYLHLWY-13 by di.qian 20180928 start
MTK_FACTORY_MODE_IN_GB2312 = no
# BSP : modify XLYLHLWY-13 by di.qian 20180928 end
# BSP: add ASQHLYB-8 by jun.fang1 20190125 begin
TRAN_RECOVERY_NOTCH_SUPPORT = yes
# BSP: add ASQHLYB-8 by jun.fang1 20190125 end
...
MTK_FIRST_MD = 1
#TSD:add XLYLHLWY-1 by ang.gu 20181010 start
MTK_FLIGHT_MODE_POWER_OFF_MD = yes
#TSD:add XLYLHLWY-1 by ang.gu 20181010 end
...
MTK_HAC_SUPPORT = no
# modify IDLHLYE-5 by ge.ding 20180611 start
MTK_HANDSFREE_DMNR_SUPPORT = no
# modify IDLHLYE-5 by ge.ding 20180611 end
...
MTK_IRTX_SUPPORT = no
#BSP:modify XLYLHLWY-12 by yongqing.dou 20181009 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP:modify XLYLHLWY-12 by yongqing.dou 20181009 end
...
#SID: add XWWYLHLYS-30 lijia.chen 20180919 start
MTK_LOG_CUSTOMER_SUPPORT = yes
#SID: add XWWYLHLYS-30 lijia.chen 20180919 end
...
#BSP: Modified ASQHLYB-6 by fan.hong 20190125 start
MTK_PUMP_EXPRESS_PLUS_30_SUPPORT = no
MTK_PUMP_EXPRESS_PLUS_SUPPORT = no
MTK_PUMP_EXPRESS_SUPPORT = no
#BSP: Modified ASQHLYB-6 by fan.hong 20190125 end
MTK_QOS_SUPPORT = no
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
#BSP: Modify XLYLHLWY-186 by yinpeng.zhang 20181220 start
MTK_UART_USB_SWITCH = yes
#BSP: Modify XLYLHLWY-186 by yinpeng.zhang 20181220 end
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
...
#TSD:modify ASQHLYB-1 by ang.gu 20190311 start
MTK_VIWIFI_SUPPORT = yes
#TSD:modify ASQHLYB-1 by ang.gu 20190311 end
...
#BSP: modify build version fail by wanhanfeng 20180828 start
MTK_WAPI_SUPPORT = no
#BSP: modify build version fail by wanhanfeng 20180828 end
MTK_WAPPUSH_SUPPORT = yes
MTK_WB_SPEECH_SUPPORT = yes
#TSD:modify ASQHLYB-1 by ang.gu 20190219 start
MTK_WFC_SUPPORT = yes
#TSD:modify ASQHLYB-1 by ang.gu 20190219 end
...
#TDD: modify KBSHLES-220 by bo.zhou 20181016 start
MTK_WMA_PLAYBACK_SUPPORT = no
#TDD: modify KBSHLES-220 by bo.zhou 20181016 end
...
#SID: add XLYLHLWY-16 by lijia.chen 20181009 start
MTK_DURASPEED_DEFAULT_ON = no
#SID: add XLYLHLWY-16 by lijia.chen 20181009 end
MTK_MCF_SUPPORT = no
...
#BSP: modify ASQHLYB-2510 by tao.lan 20190425 start
CUSTOM_KERNEL_UNCALI_ACC_SENSOR = yes
#BSP: modify ASQHLYB-2510 by tao.lan 20190425 end
...
# BSP:add ASQHLYB-4 by ge.ding 20190125 start
TRAN_AUDIOTEST_SUPPORT = yes
TRAN_SMARTPA_SUPPORT = yes
TRAN_NEW_LOOPBACK_TEST = yes
# BSP:add ASQHLYB-4 by ge.ding 20190125 end
#BSP: add custom macro by wanghanfeng 20180830 start
CUSTOM_TRAN_PROJECT=tran_ab7
CUSTOM_TRAN_BOM=tran_ab7_a1
#BSP: add custom macro by wanghanfeng 20180830 end
#BSP: add XLEWHLES-20 by wang.qin 20180929 start
...
#BSP: add XLEWHLES-20 by wang.qin 20180929 end
#BSP: add XLYLHLWY-5 by qiuwei.wang 20180928 start
TRAN_TP_SUPPORT = yes
#BSP: add XLYLHLWY-5 by qiuwei.wang 20180928 end
#BSP: add XWWYLHLYS-41 by ka.fang 20180930 start
TRAN_SYSTEM_DEVINFO=yes
#BSP: add XWWYLHLYS-41 by ka.fang 20180930 end
#//TDD:add KBQJHBLEW-6 by weijia.huang 2018.09.19 start
#SID: add XLYLHLWY-16 lijia.chen 20181009 start
...
#SID: add XLYLHLWY-16 lijia.chen 20181009 end
#CAMAP: add XLYLHLWY-104 shengjie.tang 20181227 start
include $(LOCAL_PATH)/ProjectConfig_CDD.mk
#CAMAP: add XLYLHLWY-104 shengjie.tang 20181227 end
#//TDD:add KBQJHBLEW-6 by weijia.huang 2018.09.19 end
#add XLLSHLSSP-17 by shentao.yang for porting f2fs 20180925 start
TRAN_USE_CUSTOM_FS = yes
#add XLLSHLSSP-17 by shentao.yang for porting f2fs 20180925 end
#BSP:add XLLJHBLEW-186 by hao.wu2 20180809 start
TRAN_TKV_SUPPORTED=yes
#BSP:add XLLJHBLEW-186 by hao.wu2 20180809 end
#ITD:add ASQHLYB-426 by yang.li3 20190311 start
TRAN_FLASH_SLIDE_CONTROL=yes
#ITD:add ASQHLYB-426 by yang.li3 20190311 end
#PPD: add XWWYSHJW-701 by ruishuang.jia for LUCID 18/08/03 start
TRAN_PPD_LUCID_DISABLED = no
#PPD: add XWWYSHJW-701 by ruishuang.jia for LUCID 18/08/03 end

#BSP: modify XLYLHLWY-30 by tao.lan 20181030 start
#/*---------------------- sensor team setting start -----------------------------*/#
...
#BSP: modify ASQHLYB-3235 by tao.lan 20190522 start
CUSTOM_HAL_MSENSORLIB = akm09918_ab7
#BSP: modify ASQHLYB-3235 by tao.lan 20190522 end
CUSTOM_KERNEL_ORIENTATION_SENSOR = yes
#BSP:modify ASQHLYB-2 by qiaoqiao.pan 20190122 start
TRAN_FINGERPRINT_SUPPORT = goodix_tee
TRAN_OPTICAL_FINGERPRINT=yes
#BSP:modify ASQHLYB-2 by qiaoqiao.pan 20190122 end
...
#BSP: modify ASQHLYB-2510 by tao.lan for 20190425 start
...
#BSP: modify ASQHLYB-2510 by tao.lan for 20190425 end
#BSP: add ASQHLYB-4402 by tao.lan 20191024 start
TRAN_PS_CALI_FAC = no
#BSP: add ASQHLYB-4402 by tao.lan 20191024 end
#/*---------------------- sensor team setting end -------------------------------*/#
#BSP: modify XLYLHLWY-30 by tao.lan 20181030 end
#BSP:modify ASQHLYB-19 by fan.hong 20190128 start
TRAN_CHARGING_KPOC_NUM_SITE_SUPPORT = no
#BSP:modify ASQHLYB-19 by fan.hong 20190128 end
#[ITD]add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20181115 start
TRAN_CAMERA_FEATURE = yes
#[ITD]add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20181115 end
#ITD:modify RABHLYSP-11 by quan.chang 181127 start
CUSTOM_TRAN_PCBA = tran_pcba_h618
#ITD:modify RABHLYSP-11 by quan.chang 181127 end
